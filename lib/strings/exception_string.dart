class ExceptionString {
  static const String serverExceptionString =
      "Oops we have server exception please try again later";

  static const String offlineExceptionString = "Your device is offline";

  static const String errorInformationSignInLogInString =
      "Please check your information";

  static const String tryAgainLaterString =
      "We have an error please try again later";

  static const String agreeSystemUsSignin =
